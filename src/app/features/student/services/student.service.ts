...
import { PaginatedApiResponse, QueryParam } from 'src/app/shared/models';
...
export class ClientService {
   ...
   */
  searchClients(params: QueryParam): Observable<PaginatedApiResponse<IStudent>> {
    params = this.sharedService.getQuery(params);
    return this.http.get<PaginatedApiResponse<IStudent>>(
      `${environment.apiUrl}strudents`,
      { params }
    );
  }
